...
class ImageManager:
    ...
    def _download_single_image(self, file_path: str, image: Dict[str, Any], index: int) -> Optional[Dict[str, Any]]:
        """
        ...
        if self.dry_run:
            ...
            return self._perform_download(image_url, image_path, html_dir, image_meta, index, len(image.get("images", [])))
    
    def _perform_download(self, image_url: str, image_path: str, html_dir: str, image_meta: Dict[str, Any], 
                         index: int, total_images: int) -> Optional[Dict[str, Any]]:
        """
    ...
    def _create_image_info(self, image_path: str, html_dir: str, image_meta: Dict[str, Any], is_video: bool = False) -> Dict[str, Any]:
        """
