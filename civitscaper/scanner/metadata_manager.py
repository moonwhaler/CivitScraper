...
class MetadataManager:
    ...
    def fetch_metadata(self, file_hash: str, force_refresh: bool = False) -> Optional[Dict[str, Any]]:
        """
    ...
    def save_metadata(self, file_path: str, metadata: Dict[str, Any], dry_run: bool = False) -> bool:
        """
    ...
    def fetch_and_save(self, file_path: str, file_hash: str, force_refresh: bool = False, dry_run: bool = False) -> Optional[Dict[str, Any]]:
        """
