...
class ProgressLogger:
    ...
    def __init__(self, logger: logging.Logger, total: int, description: str = "Processing", log_interval: int = 10):
        """
...
class BatchProgressTracker:
    ...
    def __init__(self, logger: logging.Logger, total_batches: int, total_items: int, description: str = "Processing"):
        """
    ...
    def start_batch(self, batch_number: int, batch_size: int):
        ...
        self.logger.info(f"{self.description} - Batch {batch_number}/{self.total_batches} ({batch_size} items)")
    ...
    def end_batch(self):
        """End current batch."""
        batch_percentage = int(self.current_batch / self.total_batches * 100) if self.total_batches > 0 else 100
        item_percentage = int(self.current_item / self.total_items * 100) if self.total_items > 0 else 100
