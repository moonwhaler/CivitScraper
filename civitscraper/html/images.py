...
class ImageHandler:
    ...
    def _get_existing_images(self, file_path: str, metadata: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        ...
        logger.debug(f"ImageHandler number of images after limiting to max_count {self.max_count}: {len(images)}")
    ...
    def _process_image(self, image_path: str, html_dir: str, image: Dict[str, Any], is_video: bool = None) -> Optional[Dict[str, Any]]:
        """
